...
Agar data bisa diproses oleh model, data kategorikal perlu diencoding menjadi data numerik, pada label target diubah kolom Graduate menjadi 1, dan Dropout menjadi 0
